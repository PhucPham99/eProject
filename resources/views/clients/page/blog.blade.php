        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-item active">Blog Right Sidebar Page</li>
                </ul>
                <!-- breadcrumb-list end -->
            </div>
        </div>
                            ...
                            <div class="recent-post-widget">
                                <div class="single-widget-post">
                                    <div class="post-thumb">
                                        <a href="#"><img src="{{ asset('client/assets/images/blog/small-blog.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="post-info">
                                ...
                                <div class="single-widget-post">
                                    <div class="post-thumb">
                                        <a href="#"><img src="{{ asset('client/assets/images/blog/small-blog-02.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="post-info">
                                ...
                                <div class="single-widget-post">
                                    <div class="post-thumb">
                                        <a href="#"><img src="{{ asset('client/assets/images/blog/small-blog-03.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="post-info">
                                        <h6 class="post-title"><a href="#">Maecenas ultricies</a></h6>
                                        <div class="post-date">Apr 24.2019</div>
                    ...
                    <div class="row">
                            ...
                            <div class="singel-latest-blog">
                                <div class="articles-image">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('client/assets/images/blog/blog-01.jpg') }}" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="singel-latest-blog">
                                <div class="articles-image">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('client/assets/images/blog/blog-02.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="aritcles-content">
                                    <div class="author-name">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="singel-latest-blog">
                                ...
                                <div class="articles-image">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('client/assets/images/blog/blog-03.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="aritcles-content">
                                    <div class="author-name">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="singel-latest-blog">
                                ...
                                <div class="articles-image">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('client/assets/images/blog/blog-04.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="aritcles-content">
                                    <div class="author-name">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="singel-latest-blog">
                                <div class="articles-image">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('client/assets/images/blog/blog-05.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="aritcles-content">
                                    <div class="author-name">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="singel-latest-blog">
                                <div class="articles-image">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('client/assets/images/blog/blog-06.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="aritcles-content">
                                    <div class="author-name">
